...
export async function seedDatabase(dataSource: DataSource) {
  ...
  const sessionsData = [
    { titleEn: 'Future of AI in Genomic Research', titleZh: '人工智能在基因组研究中的未来展望', roomEn: 'Lecture Hall 1', roomZh: '第一学术报告厅', startTime: new Date('2026-10-15T09:00'), endTime: new Date('2026-10-15T10:00'), type: SessionType.KEYNOTE, dayIndex: 0, speaker: speakers[0] },
    { titleEn: 'Breakthroughs in CAR-T Cell Therapy', titleZh: 'CAR-T细胞疗法的重大突破', roomEn: 'Seminar Hall 2', roomZh: '研讨会第二厅', startTime: new Date('2026-10-15T10:15'), endTime: new Date('2026-10-15T11:15'), type: SessionType.RESEARCH_PAPER, dayIndex: 0, speaker: speakers[1] },
    { titleEn: 'Precision Medicine: From Data to Dosage', titleZh: '精准医学：从数据到剂量', roomEn: 'Innovation Lab 4', roomZh: '创新实验室 4', startTime: new Date('2026-10-15T13:00'), endTime: new Date('2026-10-15T14:30'), type: SessionType.WORKSHOP, dayIndex: 0, speaker: speakers[2] },
    { titleEn: 'Ethical Frameworks for Global Health Data', titleZh: '全球健康数据的伦理框架', roomEn: 'Digital Suite A', roomZh: '数字套房 A', startTime: new Date('2026-10-15T15:00'), endTime: new Date('2026-10-15T16:30'), type: SessionType.PANEL, dayIndex: 0, speakerName: 'Panel: WHO Ethics Committee', speakerTitleEn: 'Multi-speaker Session', speakerTitleZh: '多讲者联合论坛' },
    { titleEn: 'Precision Medicine & AI Diagnostics', titleZh: '精准医疗与AI诊断', roomEn: 'Lecture Hall 1', roomZh: '第一学术报告厅', startTime: new Date('2026-10-16T09:00'), endTime: new Date('2026-10-16T10:30'), type: SessionType.KEYNOTE, dayIndex: 1, speaker: speakers[3] },
    { titleEn: 'Targeted Immunotherapy Workshop', titleZh: '新型靶向免疫疗法临床研讨', roomEn: 'Lab Center', roomZh: '实验教学中心', startTime: new Date('2026-10-16T11:00'), endTime: new Date('2026-10-16T12:30'), type: SessionType.WORKSHOP, dayIndex: 1, speaker: speakers[2] },
    { titleEn: 'Genomic Data in Rare Diseases', titleZh: '基因组学数据在罕见病中的应用', roomEn: 'Medical Data Lab', roomZh: '医学数据实验室', startTime: new Date('2026-10-16T14:15'), endTime: new Date('2026-10-16T15:45'), type: SessionType.RESEARCH_PAPER, dayIndex: 1, speaker: speakers[1] },
    { titleEn: 'Next-Generation Sequencing in Oncology', titleZh: '新一代基因组测序在肿瘤学中的应用', roomEn: 'Lecture Hall 1', roomZh: '第一学术报告厅', startTime: new Date('2026-10-17T09:00'), endTime: new Date('2026-10-17T10:30'), type: SessionType.KEYNOTE, dayIndex: 2, speaker: speakers[0] },
    { titleEn: 'Closing Ceremony & Awards', titleZh: '闭幕式及颁奖典礼', roomEn: 'Grand Ballroom', roomZh: '宴会大厅', startTime: new Date('2026-10-17T15:00'), endTime: new Date('2026-10-17T17:00'), type: SessionType.PANEL, dayIndex: 2, speakerName: 'Organizing Committee' },
  ];
  ...
  for (const sd of sessionsData) {
    const session = sessionRepo.create({
      ...
      speakerName: sd.speaker ? sd.speaker.nameEn : ((sd as any).speakerName || ''),
      speakerTitleEn: sd.speaker ? sd.speaker.titleEn : ((sd as any).speakerTitleEn || ''),
      speakerTitleZh: sd.speaker ? sd.speaker.titleZh : ((sd as any).speakerTitleZh || ''),
  ...
  await materialRepo.save([
    materialRepo.create({ nameEn: 'Conference Program Guide', nameZh: '大会议程指南', fileUrl: '/files/program-guide.pdf', fileSize: 2400000, type: MaterialType.PDF, eventId: event1.id }),
    materialRepo.create({ nameEn: 'Speaker Abstracts Collection', nameZh: '嘉宾摘要合集', fileUrl: '/files/abstracts.pdf', fileSize: 5100000, type: MaterialType.PDF, eventId: event1.id }),
    materialRepo.create({ nameEn: 'Workshop Preparation Materials', nameZh: '研讨会准备材料', fileUrl: '/files/workshop.pptx', fileSize: 12800000, type: MaterialType.PPT, eventId: event1.id }),
    materialRepo.create({ nameEn: 'Venue Map & Floor Plan', nameZh: '场馆地图与平面图', fileUrl: '/files/venue-map.pdf', fileSize: 1200000, type: MaterialType.PDF, eventId: event1.id }),
  ]);
