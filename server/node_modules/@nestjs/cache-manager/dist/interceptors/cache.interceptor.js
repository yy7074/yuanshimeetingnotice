...
let CacheInterceptor = class CacheInterceptor {
    ...
    trackBy(context) {
        ...
        const cacheMetadataOrFactory = this.reflector.get(cache_constants_1.CACHE_KEY_METADATA, context.getHandler()) ?? null;
        if (!isHttpApp || cacheMetadataOrFactory) {
            return (0, shared_utils_1.isFunction)(cacheMetadataOrFactory)
