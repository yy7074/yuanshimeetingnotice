...
class _EventPortalScreenState extends State<EventPortalScreen>
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: Obx(
              () => eventCtrl.searchQuery.value.isNotEmpty
                  ? IconButton(
        ...
        () => SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              _buildSortChip(eventCtrl, isZh),
              if (eventCtrl.hasActiveFilters ||
                  eventCtrl.searchQuery.value.isNotEmpty) ...[
                const SizedBox(width: 8),
                _buildClearFiltersChip(eventCtrl, primaryColor, isZh),
              ],
            ],
          ),
        ),
  ...
  Widget _buildSortChip(EventController eventCtrl, bool isZh) {
  ...
  Widget _buildClearFiltersChip(
    ...
    return GestureDetector(
      onTap: () => _clearSearchAndFilters(eventCtrl),
      child: Container(
        constraints: const BoxConstraints(minHeight: 32),
        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
        decoration: BoxDecoration(
  ...
  Widget _buildEventsList(
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) =>
          _buildEventCard(events[index], primaryColor, eventCtrl),
    );
  }

  void _clearSearchAndFilters(EventController eventCtrl) {
    _searchController.clear();
    eventCtrl.searchQuery.value = '';
    eventCtrl.clearFilters();
  }
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    else if (event.remainingSpots >= 0 &&
                    ...
                    Row(
                      children: [
                        ElevatedButton(
                          onPressed: () async {
                            final success = await eventCtrl.toggleSubscription(
                              event.id,
                            );
                            if (!success) {
                              Get.snackbar(
